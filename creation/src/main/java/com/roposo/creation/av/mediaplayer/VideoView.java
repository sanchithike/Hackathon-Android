...
import static com.roposo.creation.av.mediaplayer.MediaPlayerUtils.MEDIA_ERROR_UNKNOWN;
...
public class VideoView extends SurfaceView implements SurfaceHolder.Callback,
    ...
    private MediaPlayerUtils.OnPreparedListener mPreparedListener =
            new MediaPlayerUtils.OnPreparedListener() {
                @Override
    ...
    private MediaPlayerUtils.OnSeekListener mSeekListener = new OnSeekListener() {
        @Override
    ...
    private OnBufferingUpdateListener mBufferingUpdateListener =
            new OnBufferingUpdateListener() {
                @Override
                public void onBufferingUpdate(MediaPlayerImpl mp, int percent) {
    ...
    /**
     * @param uri
     * @see android.widget.VideoView#setVideoURI(Uri)
     * @deprecated only for compatibility with Android API
     */
    @Deprecated
     ...
     * @param uri
     * @param headers
     * @see android.widget.VideoView#setVideoURI(Uri, Map)
     * @deprecated only for compatibility with Android API
     */
    @Deprecated
    ...
    private void openVideo() {
        ...
        final Handler exceptionHandler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(Message msg) {
                mCurrentState = STATE_ERROR;
                mTargetState = STATE_ERROR;
                mErrorListener.onError(mPlayer, MEDIA_ERROR_UNKNOWN, 0);
                return true;
            }
        });
    ...
    public boolean isPrepared() {
        return getMediaPlayer() != null && getMediaPlayer().isPrepared();
    }
}
