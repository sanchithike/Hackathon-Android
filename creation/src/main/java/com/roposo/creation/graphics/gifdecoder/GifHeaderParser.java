...
/**
 * A class responsible for creating GifHeader from data
...
public class GifHeaderParser {
     ...
     */
        ...
        header.timeMapping.put(header.duration, header.frameCount);
        header.timeInverseMapping.put(header.frameCount, header.duration);
        header.duration += header.currentFrame.delay;
